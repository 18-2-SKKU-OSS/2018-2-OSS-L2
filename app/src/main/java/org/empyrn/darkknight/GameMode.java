...
// code for game mode
// The while / black player control is assigned differently depending on the mode
// analysis, Bluetooth is also assigned different permissions depending on the mode.
